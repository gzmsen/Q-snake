...
snake_pos_1 = [(HALF_WIDTH // 2) - 10, screen_height // 2 - 21]
snake_pos_2 = [(HALF_WIDTH // 2) - 10, screen_height // 2 - 11]
snake_pos_3 = [(HALF_WIDTH // 2) - 10, screen_height // 2 + 1]
snake_pos_4 = [(HALF_WIDTH // 2) - 10, screen_height // 2 + 11]

snake_rev_pos_1 = [(HALF_WIDTH - 10) + (HALF_WIDTH // 2), screen_height // 2]
snake_rev_pos_2 = [(HALF_WIDTH - 10) + (HALF_WIDTH // 2), screen_height // 2 + 10]
snake_rev_pos_3 = [(HALF_WIDTH - 10) + (HALF_WIDTH // 2), screen_height // 2 + 20]
snake_rev_pos_4 = [(HALF_WIDTH - 10) + (HALF_WIDTH // 2), screen_height // 2 + 30]

snake_pos = [snake_pos_1, snake_pos_2, snake_pos_3, snake_pos_4]

snake_reverse_pos = [snake_rev_pos_1, snake_rev_pos_2, snake_rev_pos_3, snake_rev_pos_4]
...
def check_game_over(game_over):
    ...
    if snake_out or reverse_snake_out:
        game_over = True
        pygame.mixer.music.load("wallc.mp3")
